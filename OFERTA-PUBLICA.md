# Groq Free-tier — Relatório ROUND1 + smoke script

**O que é:** pacote técnico gerado com a API Groq (LPU): relatório de limites Free-tier + script de smoke `chat/completions` (`qwen/qwen3.6-27b`).
